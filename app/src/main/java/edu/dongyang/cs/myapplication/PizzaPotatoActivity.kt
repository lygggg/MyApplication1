...
import kotlinx.android.synthetic.main.potatopizza.*

class PizzaPotatoActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.potatopizza)
        var price: Int = 12500
        pizza_plus_colla.setOnCheckedChangeListener { compoundButton, b ->
            if (pizza_plus_colla.isChecked == true) {
                price += 2000
                pizza_potato_price.text = "가격: "+price
            } else
                price -= 2000
            pizza_potato_price.text = "가격: "+price
